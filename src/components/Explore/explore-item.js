...
export default function ExploreItem({ title, image }) {
  ...
  return (
    <div className="flex-grow-0 flex-shrink-0 basis-auto bg-[#1c1816] p-2 mt-5 box-border text-center rounded-l-full rounded-tr-full rounded-br-3xl w-60 h-56 transition duration-300 ease-in-out hover:-translate-y-4 ">
      <Image
        src={image}
