...
export default function SellerItem({ title, image, price }) {
  ...
  return (
    <div className="flex-grow-0 flex-shrink-0 basis-auto bg-[#1c1816] mr-5 box-border text-left pt-2.5 px-2.5 pb-0 rounded-md h-[400px]">
      <div className="text-center -m-1.5">
        <span className="bg-[#EA002A] px-2 py-1.5 mr-1.5"></span>
        <span className="bg-[#EA002A] px-2 py-1.5 mr-1.5"></span>
        <span className="bg-[#EA002A] px-2 py-1.5"></span>
      </div>
      <p className="text-2xl pt-[30px] tracking-tighter">{title}</p>
